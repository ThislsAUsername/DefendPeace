...
public class Jugger extends AWBWCommander
{
  ...
  private static class instantiator extends CommanderInfo
  {
    ...
    public instantiator()
    {
      super("Jugger", UIUtils.SourceGames.AWBW, UIUtils.BH);
  ...
  private static class Overclock extends AWBWAbility
  {
    private static final long serialVersionUID = 1L;
  ...
  private static class SystemCrash extends AWBWAbility
  {
    private static final long serialVersionUID = 1L;
