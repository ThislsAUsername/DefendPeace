...
import CommandingOfficers.Variants.BH.Qis;
...
{  
  ...
  private static void buildCommanderList()
  {
    ...
    commanderList.add( CommandingOfficers.Variants.OS.Sami.getInfo() );
    commanderList.add( CommandingOfficers.Variants.OS.SamiLevels.getInfo() );
    commanderList.add( CommandingOfficers.Variants.OS.NellWarCrimes.getInfo() );
    commanderList.add( CommandingOfficers.Variants.BM.OlafDSBW.getInfo() );
    commanderList.add( CommandingOfficers.Variants.BM.Colin.getInfo() );
    commanderList.add( CommandingOfficers.Variants.BM.Sasha.getInfo() );
    commanderList.add( CommandingOfficers.Variants.GE.JessDSBW.getInfo() );
    ...
    commanderList.add( CommandingOfficers.Variants.YC.SonjaDSBW.getInfo() );
    commanderList.add( CommandingOfficers.Variants.YC.KanbeiDSBW.getInfo() );
    ...
    commanderList.add( CommandingOfficers.Variants.BH.VonBoltLevel.getInfo() );
    ...
    commanderList.add( CommandingOfficers.AW2.GE.Jess.getInfo() );
    ...
    commanderList.add( CommandingOfficers.AW3.GE.Jess.getInfo() );
    ...
    commanderList.add( CommandingOfficers.AWBW.GE.Jess.getInfo() );
