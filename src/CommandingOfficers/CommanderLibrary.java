...
{  
  ...
  private static void buildCommanderList()
  {
    ...
    commanderList.add( CommandingOfficers.DefendPeace.misc.Seth.getInfo() );
    ...
    commanderList.add( CommandingOfficers.AWBW.BM.OlafDSBW.getInfo() );
    ...
    commanderList.add( CommandingOfficers.AWBW.GE.JessDSBW.getInfo() );
    ...
    commanderList.add( CommandingOfficers.AWBW.YC.KanbeiDSBW.getInfo() );
