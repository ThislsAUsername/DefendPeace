...
public class MoveTypeSea extends MoveType
{
  ...
  public MoveTypeSea()
  {
    ...
    moveCosts.get(Weathers.CHILL  ).setAllSeaCosts(1);
    moveCosts.get(Weathers.SLEET  ).setAllSeaCosts(1);
    moveCosts.get(Weathers.SMOKE  ).setAllSeaCosts(1);
    moveCosts.get(Weathers.SIROCCO).setAllSeaCosts(1);
