...
public class CommanderOverlayArtist
{
  ...
  public static BufferedImage buildCoPowerBar(Commander co, double[] abilityPoints, double currentPower, boolean leftSide)
  {
    ...
    BufferedImage powerBar = SpriteLibrary.getCoOverlayPowerBar(co, (int) (maxAP*3), co.getAbilityPower()*3);
    ...
    for( int i = 0; i < abilityPoints.length; ++i )
    {
      ...
      int drawLoc = (int) ((requiredPower* 3 * 2) - imageBufferW - 3); // -3 to center the image around the power level.
